...
from openstack_dashboard.dashboards.admin.blades import views

urlpatterns = patterns('openstack_dashboard.dashboards.admin.blades.views',
    url(r'^$', views.IndexView.as_view(), name='index'),
    url(r'^(?P<blade_id>[^/]+)/detail/$', views.DetailView.as_view(), name='detail'),
