...
class TestAPINodes(unittest.TestCase):
    ...
    def test_check_consistency_success(self):
        ...
        node_hw = test_utils.get_test_composed_node()
        # Set different uuid. Because valence assign uuid for each node, db will
        # have different uuid. It will not check uuid field.
    ...
    def test_get_composed_node_by_uuid(self, mock_db_get_composed_node,
        mock_redfish_get_node, mock_db_update_composed_node):
        ...
        mock_redfish_get_node.return_value = test_utils.get_test_composed_node()
    ...
    def test_get_composed_node_by_uuid_and_update(
        ...
        Node related info is inconsistent with corresponding hardware node info.
        Need to update corresponding db entry.
        """
