...
class PCIeSwitchTabs(tabs.TabGroup):

    slug = "pcie_switch_group_tabs"
...
class OverviewTab(tabs.Tab):
    name = _("Overview")
    slug = "overview"
    template_name = ("admin/rack_managers/"
                     "_detail_overview.html")

    def get_context_data(self, request):
        return {"rack_manager": self.tab_group.kwargs['rack_manager'], "rack_manager_id": self.tab_group.kwargs['rack_manager_id']}
...
class RackManagerDetailTabs(tabs.TabGroup):
    slug = "rack_manager_details"
