...
def _error(requestid, error_code, http_status, error_title, error_detail):
...
def httpexception(e):
    return _error(FAKE_REQUEST_ID, type(e).__name__, e.code,
                  type(e).__name__, str(e))


def generalexception(e, errorcode):
    return _error(FAKE_REQUEST_ID, type(e).__name__, errorcode,
                  type(e).__name__, str(e))
