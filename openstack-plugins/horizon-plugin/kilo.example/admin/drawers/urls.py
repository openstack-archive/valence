...
from openstack_dashboard.dashboards.admin.drawers import views

urlpatterns = patterns('openstack_dashboard.dashboards.admin.drawers.views',
    url(r'^$', views.IndexView.as_view(), name='index'),
    url(r'^(?P<drawer_id>[^/]+)/detail/$', views.DetailView.as_view(), name='detail'),
