...
class Connection(api.Connection):
    ...
    def _add_nodes_filters(self, query, filters):
        ...
        if 'inspection_started_before' in filters:
            limit = ((timeutils.utcnow()) -
                     (datetime.timedelta(seconds=filters['inspection_started_before'])))
    ...
    def get_nodeinfo_list(self, columns=None, filters=None, limit=None, marker=None, sort_key=None, sort_dir=None):
        ...
        return _paginate_query(models.Node, limit, marker, sort_key, sort_dir, query)
    ...
    def get_chassis_list(self, limit=None, marker=None, sort_key=None, sort_dir=None):
        return _paginate_query(models.Chassis, limit, marker, sort_key, sort_dir)
    ...
    def get_xclarity_list(self, filters=None, limit=None, marker=None, sort_key=None, sort_dir=None):
        ...
        return _paginate_query(models.xClarityInstance, limit, marker, sort_key, sort_dir, query)
    ...
    def get_subscription_list(self, filters=None, limit=None, marker=None, sort_key=None, sort_dir=None):
        ...
        return _paginate_query(models.Subscription, limit, marker, sort_key, sort_dir, query)
    ...
    def update_subscription(self, subscription_id, values):
        ...
        try:
            ...
            raise exception.SubscriptionAlreadyExists(tenant_id=values['tenant_id'])
        return ref
    ...
    def update_pod_manager(self, pod_manager_id, values):
        ...
        try:
            with session.begin():
                query = model_query(models.PodManager, session=session).filter_by(id=pod_manager_id)
                query.update(values)
                ref = query.one()
        except NoResultFound:
            raise exception.PodManagerNotFound(pod_manager=pod_manager_id)
        except db_exc.DBDuplicateEntry:
            raise exception.PodManagerAlreadyExist(pod_manager=values['tenant_id'])
        return ref
    ...
    def get_pod_manager_list(self, filters=None, limit=None, marker=None, sort_key=None, sort_dir=None):
        ...
        if filters is not None:
            ...
            filters = {'type': DRIVER_RSA_PODM_INSTANCE_TYPE}
        query = self._add_xclarity_filters(query, filters)
        return _paginate_query(models.PodManager, limit, marker, sort_key, sort_dir, query)
    ...
    def get_pod_manager_by_ip(self, pod_manager_ip):
        query = model_query(models.PodManager).filter_by(ipaddress=pod_manager_ip)
        try:
            return query.one()
        except NoResultFound:
    ...
    def get_rsa_chassis_list_by_pod_and_type(self, pod_id, chassis_type, limit=None, marker=None, sort_key=None,
                                             sort_dir=None):
        query = model_query(models.RSAChassis).filter_by(pod_id=pod_id, type=chassis_type)
        # query = model_query(models.RSAChassis).filter(pod_id=pod_id,
        # RSAChassis.chassis_type!='Rack')
        return _paginate_query(models.RSAChassis, limit, marker, sort_key, sort_dir, query)
        ...
        try:
            with session.begin():
                if chassis_type is not None:
                    query = model_query(models.RSAChassis).filter_by(type=chassis_type, pod_id=pod_id)
                else:
    ...
    def get_rack_resource(self, pod_id, rack_id):
        pod_type = model_query(models.PodManager).filter_by(id=pod_id).one().type
        rack_name = model_query(models.RSAChassis.name).filter_by(id=rack_id)
        # drawer resource
        drawer_query = model_query(models.RSAChassis).filter_by(type='Drawer', pod_id=pod_id)
        drawer_sum = drawer_query.filter(models.RSAChassis.location.contains(rack_name)).count()
        # compuer_system resource
        if pod_type == "INTEL-COMMON":
            compuer_system_query = model_query(models.ComputerSystem).filter_by(pod_id=pod_id)
            compuer_system_sum = compuer_system_query.filter(models.ComputerSystem.location.contains(rack_name)).count()
        else:
            compuer_system_query = model_query(models.ComputerSystem).filter_by(pod_id=pod_id)
        ...
        switch_sum = switch_query.filter(models.Switch.location.contains(rack_name)).count()
        return {'drawer_sum': drawer_sum, 'computer_system_sum': compuer_system_sum, 'ethernet_switch_sum': switch_sum}

    def get_rack_computer_systems(self, pod_id, chassis, chassis_id):
        pod_type = model_query(models.PodManager).filter_by(id=pod_id).one().type
        query = model_query(models.ComputerSystem.name, models.ComputerSystem.id,
                            models.ComputerSystem.location).filter_by(pod_id=pod_id)
        if pod_type == "INTEL-COMMON":
            computer_systems = query.filter(models.ComputerSystem.location.contains(chassis))
        else:
            computer_systems = query.filter(models.ComputerSystem.location.contains(str(chassis_id)))
    ...
    def get_rack_view_by_rack_id(self, rack_id):
        ...
        return _paginate_query(models.RackView, sort_key=models.RackView.begin_at, query=query)
    ...
    def get_node_cpu_list(self, rsa_node_id, limit=None, marker=None, sort_key=None, sort_dir=None):
        query = model_query(models.CPU).filter_by(computer_system_id=rsa_node_id)
        return _paginate_query(models.CPU, limit, marker, sort_key, sort_dir, query)

    def get_cpu_list(self, limit=None, marker=None, sort_key=None, sort_dir=None):
        query = model_query(models.CPU)
        return query.all()

    def get_cpu_sum_by_systems(self, system_id_list):
        try:
            cpu_sum = model_query(models.CPU).filter(models.CPU.computer_system_id.in_(system_id_list)).count()
            return cpu_sum
        except NoResultFound:
    ...
    def destroy_cpu(self, computer_system_id):
        ...
        try:
            with session.begin():
                query = model_query(models.CPU).filter_by(computer_system_id=computer_system_id)
                query.delete()
        except NoResultFound:
    ...
    def get_node_memory_list(self, rsa_node_id, limit=None, marker=None, sort_key=None, sort_dir=None):
        query = model_query(models.Memory).filter_by(computer_system_id=rsa_node_id)
        return _paginate_query(models.Memory, limit, marker, sort_key, sort_dir, query)

    def get_mem_list(self, limit=None, marker=None, sort_key=None, sort_dir=None):
        query = model_query(models.Memory)
        return query.all()

    def get_mem_sum_by_systems(self, system_id_list):
        try:
            query = model_query(func.sum(models.Memory.capacity_mb)).filter(models.Memory.computer_system_id.in_(system_id_list))
    ...
    def destroy_mem(self, computer_system_id):
        ...
        try:
            with session.begin():
                query = model_query(models.Memory).filter_by(computer_system_id=computer_system_id)
                query.delete()
        except NoResultFound:
    ...
    def get_node_disk_list(self, rsa_node_id, limit=None, marker=None, sort_key=None, sort_dir=None):
        query = model_query(models.Disk).filter_by(computer_system_id=rsa_node_id)
        return _paginate_query(models.Disk, limit, marker, sort_key, sort_dir, query)

    def get_disk_list(self, limit=None, marker=None, sort_key=None, sort_dir=None):
        query = model_query(models.Disk)
        return query.all()

    def get_disk_sum_by_systems(self, system_id_list):
        try:
            query = model_query(func.sum(models.Disk.size_gb)).filter(models.Disk.computer_system_id.in_(system_id_list))
            size_sum = int(query.all()[0][0])
            return size_sum
        except NoResultFound:
    ...
    def destroy_disk(self, computer_system_id):
        ...
        try:
            with session.begin():
                query = model_query(models.Disk).filter_by(computer_system_id=computer_system_id)
                query.delete()
        except NoResultFound:
    ...
    def get_pod_switch_list(self, pod_id, limit=None, marker=None, sort_key=None, sort_dir=None):
        ...
        return _paginate_query(models.Switch, limit, marker, sort_key, sort_dir, query)
    ...
    def get_computer_system_list(self, pod_id, limit=None, marker=None, sort_key=None, sort_dir=None):
        query = model_query(models.ComputerSystem).filter_by(pod_id=pod_id)
        return _paginate_query(models.ComputerSystem, limit, marker, sort_key, sort_dir, query)

    def get_computer_system_by_id(self, computer_system_id):
        query = model_query(models.ComputerSystem).filter_by(id=computer_system_id)
        try:
            return query.one()
        except NoResultFound:
            raise exception.ComputerSystemNotFound(ComputerSystem=computer_system_id)
    ...
    def create_computer_system(self, values):
        ...
        try:
            ...
            raise exception.ComputerSystemAlreadyExist(ComputerSystem=values['url'])
    ...
    def destroy_computer_system(self, pod_id):
        ...
        try:
            with session.begin():
                ...
                query.delete()
                # delete cpus
                cpus_query = model_query(models.CPU).filter(models.CPU.computer_system_id.in_(system_ids))
                cpus_query.delete(synchronize_session='fetch')
                # delete memorys
                mems_query = model_query(models.Memory).filter(models.Memory.computer_system_id.in_(system_ids))
                mems_query.delete(synchronize_session='fetch')
                # delete disks
                disks_query = model_query(models.Disk).filter(models.Disk.computer_system_id.in_(system_ids))
    ...
    def get_composed_node_list(self, pod_id, limit=None, marker=None, sort_key=None, sort_dir=None):
        query = model_query(models.ComposedNode).filter_by(pod_id=pod_id)
        return _paginate_query(models.ComposedNode, limit, marker, sort_key, sort_dir, query)
    ...
    def get_by_volume_id(self, volume_id):
        composed_node = model_query(models.ComposedNode.name, models.ComposedNode.id).filter(
            models.ComposedNode.volume_id.contains(volume_id))
        return composed_node

    def get_composed_node_by_system_id(self, system_id):
        query = model_query(models.ComposedNode.name, models.ComposedNode.id).filter_by(computer_system_id=system_id)
        try:
            return query.one()
        except NoResultFound:
            return None
    ...
    def get_system_id_list(self, pod_id):
        id_list = model_query(models.ComposedNode.computer_system_id).filter_by(pod_id=pod_id)
        return id_list
    ...
    def create_composed_node(self, values):
        ...
        try:
            ...
            raise exception.ComposedNodeAlreadyExist(ComposedNode=values['url'])
        return composed_node
    ...
    def get_pod_volume_list(self, pod_id, limit=None, marker=None, sort_key=None, sort_dir=None):
        ...
        return _paginate_query(models.Volume, limit, marker, sort_key, sort_dir, query)
    ...
    def get_node_interface_list(self, node_id, limit=None, marker=None, sort_key=None, sort_dir=None):
        query = model_query(models.Interface).filter_by(computer_system_id=node_id)
        return _paginate_query(models.Interface, limit, marker, sort_key, sort_dir, query)
    ...
    def destroy_interface(self, computer_system_id):
        ...
        try:
            with session.begin():
                query = model_query(models.Interface).filter_by(computer_system_id=computer_system_id)
                query.delete()
        except NoResultFound:
    ...
    def get_manager_list(self, pod_id, limit=None, marker=None, sort_key=None, sort_dir=None):
        ...
        return _paginate_query(models.Manager, limit, marker, sort_key, sort_dir, query)
    ...
    def get_target_list_by_pod(self, pod_id, limit=None, marker=None, sort_key=None, sort_dir=None):
        ...
        return _paginate_query(models.RemoteTarget, limit, marker, sort_key, sort_dir, query)
    ...
    def get_pcieswitch_list_by_pod(self, pod_id, limit=None, marker=None, sort_key=None, sort_dir=None):
        ...
        return _paginate_query(models.PCIeSwitch, limit, marker, sort_key, sort_dir, query)
