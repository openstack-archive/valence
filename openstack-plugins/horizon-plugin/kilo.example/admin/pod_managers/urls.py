...
from openstack_dashboard.dashboards.admin.pod_managers import views

urlpatterns = patterns('openstack_dashboard.dashboards.admin.pod_managers.views',
    url(r'^$', views.IndexView.as_view(), name='index'),
    url(r'^addnew$', views.AddNewPodManagerView.as_view(), name='addnew'),
    url(r'^(?P<pod_manager_id>[^/]+)/edit/$', views.EditPodManagerView.as_view(), name='edit_pod_manager'),
