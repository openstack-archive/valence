...
from openstack_dashboard.dashboards.admin.rsa_servers import views

urlpatterns = patterns('openstack_dashboard.dashboards.admin.rsa_servers.views',
    url(r'^$', views.IndexView.as_view(), name='index'),
    url(r'^(?P<server_id>[^/]+)/detail/$', views.DetailView.as_view(), name='detail'),
