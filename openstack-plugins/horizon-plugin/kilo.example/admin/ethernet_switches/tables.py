...
class CreateVirtualDiskLink(tables.LinkAction):
    name = "createvirtualdisk"
    verbose_name = _("Create Virtual Disk")
    url = "horizon:admin:pcie_switches:create_virtual_disk"
    classes = ("ajax-modal", "btn-edit",)
    icon = "pencil"

    def __init__(self, attrs=None, **kwargs):
        kwargs['preempt'] = True
        super(CreateVirtualDiskLink, self).__init__(attrs, **kwargs)

    def allowed(self, request, datum):
        return True  # The action should always be displayed

class DeleteVirtualDiskLink(tables.LinkAction):
    name = "deletevirtualdisk"
    verbose_name = _("Delete Virtual Disk")
    url = "horizon:admin:pcie_switches:delete_virtual_disk"
    classes = ("ajax-modal", "btn-danger",)

    def __init__(self, attrs=None, **kwargs):
        kwargs['preempt'] = True
        super(DeleteVirtualDiskLink, self).__init__(attrs, **kwargs)
...
class AdminRefreshInventory(tables.LinkAction):
    ...
    name = "refresh"
    verbose_name = _("Refresh Inventory")
    url = "horizon:admin:pcie_switches:refresh"
    classes = ("ajax-modal",)
    icon = "refresh"
    ajax = True
...
class AdminEthernetSwitchTable(tables.DataTable):
    TASK_STATUS_CHOICES = (
        (None, True),
        ("none", True)
    )
    ...
    name = tables.Column("name",
                         link=("horizon:admin:ethernet_switches:"
                               "detail"),
                         verbose_name=_("Name"))
    status = tables.Column("status",
                         verbose_name=_("Status"))
    #ip_addr = tables.Column("ip_addr",
    #                     verbose_name=_("IP address"))
    serial_number = tables.Column("serial_number",
                         verbose_name=_("Serial Number"))
    part_number = tables.Column("part_number",
    ...
    class Meta(object):
        name = "pcie_switches"
        verbose_name = _("Pcie_switches")
        table_actions = (AdminPcieswitchesFilterAction, AdminRefreshInventory)
        #row_actions = (CreateVirtualDiskLink,DeleteVirtualDiskLink,)
        row_actions = ()
        cell_class = LenovoSwitchesCell
        '''
