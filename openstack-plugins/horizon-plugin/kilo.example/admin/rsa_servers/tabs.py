...
class OverviewTab(tabs.Tab):
    name = _("Overview")
    slug = "overview"
    template_name = ("admin/rsa_servers/"
                     "_detail_overview.html")

    def get_context_data(self, request):
        return {"rsa_server": self.tab_group.kwargs['rsa_server'], "server_id": self.tab_group.kwargs['server_id']}

class EventlogTab(tabs.TableTab):
    name = _("Event Log")
    slug = "eventlog"
    table_classes = (EventlogTable,)
    template_name = "admin/rsa_servers/_detail_table.html"
    preload = False
...
class RsaServerDetailTabs(tabs.TabGroup):
    slug = "rsa_server_details"
