...
from openstack_dashboard.dashboards.admin.blades.tables import EventlogTable
...
class OverviewTab(tabs.Tab):
    name = _("Overview")
    slug = "overview"
    template_name = ("admin/blades/"
                     "_detail_overview.html")

    def get_context_data(self, request):
        return {"blade": self.tab_group.kwargs['blade'], "blade_id": self.tab_group.kwargs['blade_id']}
...
class BladeDetailTabs(tabs.TabGroup):
    slug = "pcie_switch_details"
