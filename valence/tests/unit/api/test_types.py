...
class TestTypes(TestCase):
    ...
    def test_bool_type(self):
        ...
        self.assertEqual(test_value, types.Bool.validate('Tt'))
        self.assertEqual(test_value, types.Bool.validate('no'))
        self.assertEqual(test_value, types.Bool.validate(''))
        self.assertEqual(test_value, types.Bool.validate('10'))
