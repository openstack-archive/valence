...
from openstack_dashboard.dashboards.admin.rack_managers import views

urlpatterns = patterns('openstack_dashboard.dashboards.admin.rack_managers.views',
    url(r'^$', views.IndexView.as_view(), name='index'),
    url(r'^(?P<rack_manager_id>[^/]+)/detail/$', views.DetailView.as_view(), name='detail'),
