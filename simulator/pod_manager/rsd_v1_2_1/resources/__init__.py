...
from simulator.pod_manager.rsd_v1_2_1.common import generate_members

computer_systems = {}
composed_nodes = {}

systems_members = generate_members('System', '/redfish/v1/System/', 48)

nodes_members = generate_members('Node', '/redfish/v1/Node/', 6)
    ...
    for number in range(1, 7):
        ...
        node_info = {
            ...
            "Links": {
                ...
                "LocalDrives": [
                    {
                        "@odata.id": "/redfish/v1/Services/service1/"
                                     "LogicalDrives/volume%d" % (number*2 - 1)
                    },
                    {
                        "@odata.id": "/redfish/v1/Services/service1/"
                                     "LogicalDrives/volume%d" % (number * 2)
                    }
                ],
                "RemoteDrives": [
                    {
