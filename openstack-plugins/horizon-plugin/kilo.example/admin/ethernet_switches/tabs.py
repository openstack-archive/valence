...
class OverviewTab(tabs.Tab):
    name = _("Overview")
    slug = "overview"
    template_name = ("admin/ethernet_switches/"
                     "_detail_overview.html")

    def get_context_data(self, request):
        return {"switch": self.tab_group.kwargs['switch'], "switch_id": self.tab_group.kwargs['switch_id']}
...
class SwitchDetailTabs(tabs.TabGroup):
    slug = "switch_details"
