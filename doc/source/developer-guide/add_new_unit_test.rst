...
Currently, valence uses pythons unittest module and mock module for running the testcases.
...
Consider implementing an unit testcase for our /example unit module
