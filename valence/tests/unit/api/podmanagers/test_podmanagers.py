...
class TestPodManagers(unittest.TestCase):
    @mock.patch('valence.api.podmanagers.podmanagers.get_podm_list')
    @mock.patch('valence.api.podmanagers.podmanagers.get_podm_status')
    ...
    @mock.patch('valence.api.podmanagers.podmanagers.get_podm_by_uuid')
