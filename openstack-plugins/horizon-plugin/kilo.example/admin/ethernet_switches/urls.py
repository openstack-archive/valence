...
from openstack_dashboard.dashboards.admin.ethernet_switches import views

urlpatterns = patterns('openstack_dashboard.dashboards.admin.ethernet_switches.views',
    url(r'^$', views.IndexView.as_view(), name='index'),
    url(r'^(?P<switch_id>[^/]+)/detail/$', views.DetailView.as_view(), name='detail'),
    #url(r'^drawer_info/(?P<drawer_id>[^/]+)/$', views.GetOneDrawerInfoView.as_view(), name='get_one_drawer_info'),
