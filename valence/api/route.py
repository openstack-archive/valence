...
api.add_resource(v1_op_flavors.OpenstackFlavorsList, '/v1/openstack_flavors',
                 endpoint='openstack_flavors')
api.add_resource(v1_op_flavors.OpenstackFlavorShow,
                 '/v1/openstack_flavors/<string:flavoruuid>',
                 endpoint='openstack_flavor_show')
api.add_resource(v1_op_flavors.RegisterFlavor,
                 '/v1/openstack_flavors/<string:flavoruuid>/register',
                 endpoint='openstack_flavor_register')
api.add_resource(v1_op_flavors.OpenstackFlavors,
                 '/v1/openstack_flavors/<string:flavoruuid>',
                 endpoint='openstack_flavor_delete')
api.add_resource(v1_op_flavors.OpenstackFlavors, '/v1/openstack_flavors',
                 endpoint='openstack_flavor_create')
