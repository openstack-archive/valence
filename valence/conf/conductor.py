...
conductor_service_opts = [
    cfg.PortOpt('async_bind_port',
                default=5560,
                help=_('The port for the conductor server.')),
    cfg.PortOpt('sync_bind_port',
                default=5561,
                help=_('The port for the conductor server.')),
    cfg.IPOpt('bind_host',
              default='127.0.0.1',
              help=_('The listen IP for the conductor server.')),
    cfg.StrOpt('compute_topic',
               default='compute',
               help=_('The topic on which conductor service listens')),
    cfg.BoolOpt('debug',
                default=False,
                help=_('Enable debug mode for conductor service.'))
]

log_option = [
    cfg.StrOpt('log_file',
               default='/var/log/valence/conductor/conductor.log',
               help=_('The log file location for conductor service')),
...
conductor_group = cfg.OptGroup(name='conductor',
                               title='Options for the conductor'
                               + ' service')
